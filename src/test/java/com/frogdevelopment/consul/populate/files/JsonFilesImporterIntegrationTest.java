...
class JsonFilesImporterIntegrationTest {
    ...
    @Test
    void should_mergeJson() throws IOException {
        // given
        final var rootUrl = loader.getResource("classpath:files/application.json");
        ...
        assertThat(result.get("application")).isEqualToIgnoringWhitespace("""
                {
                   "very" : {
                     "deep" : {
                       "nested" : {
